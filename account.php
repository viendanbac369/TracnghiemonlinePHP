            ...
            <div class="col-lg-6">
                ...
                <div class="col-md-4 col-md-offset-2">
                 ...
                 if (!(isset($_SESSION['username']))) {
                    ...
                    include_once 'dbConnection.php';
                    echo '<span class="pull-right top title1" ><span style="color:white"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Chào,</span> <span class="log log1" style="color:lightyellow">' . $username . '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php?q=account.php" style="color:lightyellow"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Đăng xuất</button></a></span>';
                }
                ?>
            </div>
        </div></div>
        <div class="bg">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                if (@$_GET['q'] == 1)
                    echo 'class="active"';
                ?> ><a href="account.php?q=1"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Trang chủ</a></li>
                <li <?php
                if (@$_GET['q'] == 2)
                    echo 'class="active"';
                ?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Lịch sử</a></li>
                <li <?php
                if (@$_GET['q'] == 3)
                    echo 'class="active"';
                ?>><a href="account.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Bảng xếp hạng</a></li>
                <li <?php
                if (@$_GET['q'] == 4)
                    echo 'class="active"';
                ?>><a href="account.php?q=4"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Tài liệu</a></li>
            </ul>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if (@$_GET['q'] == 1) {
                ...
                <tr><td style="vertical-align:middle"><b>STT</b></td><td style="vertical-align:middle"><b>Đề</b></td><td style="vertical-align:middle"><b>Tổng số câu hỏi</b></td><td style="vertical-align:middle"><b>Câu trả lời đúng</b></td><td style="vertical-align:middle"><b>Câu trả lời sai</b></td><td style="vertical-align:middle"><b>Tổng điểm</b></td><td style="vertical-align:middle"><b>Thời gian </b></td><td style="vertical-align:middle"><b>Bắt đầu</b></td></tr>';
                $c = 1;
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    if ($rowcount == 0) {
                        ...
                        if ($remaining > 0 && $qstatus == "enabled" && $status == "ongoing") {
                            ...
                            <td style="vertical-align:middle"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="margin:0px;background:darkorange;color:white">&nbsp;<span class="title1"><b>Tiếp tục</b></span></a></b></td></tr>';
                        } else {
                            echo '<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">+' . $correct . '</td><td style="vertical-align:middle">-' . $wrong . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td>
...
//Process Page Thi
                ...
                if (mysqli_num_rows($q) > 0) {
                  ...
                  function secondPassed() {
                    ...
                    if ($_GET["t"] > $_GET["n"] && $_GET["n"] != 1) {
                        echo '<br /><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-default" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Chọn</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" onclick="frmreset()" style="height:30px"></span><font style="font-size:12px;font-weight:bold">Bỏ chọn</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"  style="font-size:12px"></span></a></form><br><br>';
                    } else if ($_GET["t"] == $_GET["n"]) {
                        echo '<br /><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-default" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Chọn</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" onclick="frmreset()" style="height:30px"></span><font style="font-size:12px;font-weight:bold">Bỏ chọn</font></button>&nbsp;&nbsp;&nbsp;&nbsp;</form><br><br>';
      ...
      if (@$_GET['q'] == 'result' && @$_GET['eid']) {
        ...
        if ($status == "finished") {
            ...
            echo '<tr style="color:darkblue"><td style="vertical-align:middle">Tổng số câu hỏi</td><td style="vertical-align:middle">' . $total . '</td></tr>
            <tr style="color:darkgreen"><td style="vertical-align:middle">Câu trả lời đúng&nbsp;<span class="glyphicon glyphicon-ok-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $r . '</td></tr> 
            <tr style="color:red"><td style="vertical-align:middle">Câu trả lời sai&nbsp;<span class="glyphicon glyphicon-remove-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $w . '</td></tr>
            <tr style="color:orange"><td style="vertical-align:middle">Bỏ trống&nbsp;<span class="glyphicon glyphicon-ban-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . ($total - $r - $w) . '</td></tr>
            <tr style="color:darkblue"><td style="vertical-align:middle">Điểm&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
            $q = mysqli_query($con, "SELECT * FROM rank WHERE  username='$username' ") or die('Error157');
            while ($row = mysqli_fetch_array($q)) {
                $s = $row['score'];
                echo '<tr style="color:#990000"><td style="vertical-align:middle">Tổng điểm&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
            }
            echo '<tr></tr></table></div><div class="panel"><br /><h3 align="center" style="font-family:calibri">:: Chi tiết ::</h3><br /><ol style="font-size:20px;font-weight:bold;font-family:calibri;margin-top:20px">';
...
//
    if (@$_GET['q'] == 2) {
        ...
        <tr><td style="vertical-align:middle"><b>STT</b></td><td style="vertical-align:middle"><b>Đề</b></td><td style="vertical-align:middle"><b> Tổng số câu hỏi</b></td><td style="vertical-align:middle"><b>Số câu Đúng</b></td><td style="vertical-align:middle"><b>Số câu sai<b></td><td style="vertical-align:middle"><b>Bỏ trống<b></td><td style="vertical-align:middle"><b>Điểm</b></td><td style="vertical-align:middle"><b>Bắt đầu<b></td></tr>';
        $c = 0;
        while ($row = mysqli_fetch_array($q)) {
            $eid = $row['eid'];
            $s   = $row['score'];
    ...
    if (@$_GET['q'] == 3) {
        ...
        echo '<div class="panel title">
        <table class="table table-striped title1" >
        <tr><td style="vertical-align:middle"><b>Xếp hạng</b></td><td style="vertical-align:middle"><b>Tên</b></td><td style="vertical-align:middle"><b>Ngành</b></td><td style="vertical-align:middle"><b>Tên đăng nhập</b></td><td style="vertical-align:middle"><b>Điểm</b></td></tr>';
        $c = $showfrom-1;
    ...
    if (@$_GET['q'] == 4) {
        ...
        <table class="table table-striped title1" >
        <tr><td style="vertical-align:middle"><b>STT</b></td><td style="vertical-align:middle"><b> Tên file</b></td><td style="vertical-align:middle"><b>Ngày</b></td><td style="vertical-align:middle"><b>Kích cỡ<b></td><td style="vertical-align:middle"><b>Loại file<b></td><td style="vertical-align:middle"><b>Tải xuống<b></td></tr>';
        $c = 0;
        while ($row = mysqli_fetch_array($q)) {
            $id=$row['id'];
            $name=$row['name'];
...
<footer>
 ...
 <div class="col-md-3 box">
    <a href="#" data-toggle="modal" style="color:lightyellow;" target="new">Copyright 2020 by ABC</a>
</div>
<div class="col-md-2 box">
    <a href="feedback.php" style="color:lightyellow;text-decoration:underline"  target="new">Phản hồi</a></div>
</div>
</footer>
</body>
</html>
